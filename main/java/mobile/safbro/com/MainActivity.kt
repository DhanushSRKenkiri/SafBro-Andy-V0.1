...
import mobile.safbro.com.presentation.sign_in.SignInScreen
import mobile.safbro.com.presentation.sign_in.SignInViewModel
            ...
            ComposeGoogleSignInCleanArchitectureTheme {
                ...
                Surface(
                    ...
                    NavHost(navController = navController, startDestination = "sign_in") {
                        ...
                        composable("profile") {
                            ProfileScreen(
                                userId = googleAuthUiClient.getSignedInUser()?.userId, // Replace with your actual user ID retrieval logic
                                onSignOut = {
                                    lifecycleScope.launch {
